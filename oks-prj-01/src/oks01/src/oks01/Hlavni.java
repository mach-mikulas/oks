...
public class Hlavni {
  ...
  public static final Logger hlavniLogger = LogManager.getLogger(Hlavni.class.getSimpleName());
  ...
  public static void main(String[] args) {
    ...
    hlavniLogger.info("Konec programu - vysledky jsou v souboru: vysledky.txt");
  }
